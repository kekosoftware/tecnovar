...
class ManufactureController extends Controller
{
	...
	public function save_manufacture(Request $request)
	{
		...
		Session::put('message','La Marca ha sido agregado correctamente');
	...
	public function unactive_manufacture($manufacture_id)
	{
		...
		Session::put('message','La Marca ha sido Actualizado correctamente');
	...
	public function edit_manufacture($manufacture_id)
	{
		...
		//Session::put('message','La categoria ha sido Actualizado correctamente');
	...
	public function delete_manufacture($manufacture_id)
	{
		...
		Session::put('message','La Marca se ha borrado correctamente');
