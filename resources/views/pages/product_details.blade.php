	...
	<div id="breadcrumb">
		<div class="container">
			<ul class="breadcrumb">
				...
				<li><a href="{{URL::to('/products_by_category/'.$product_by_details->category_id)}}">{{$product_by_details->category_name}}</a></li>
				<li class="active">{{$product_by_details->product_name}}</li>
			</ul>
		</div>
	</div>
	<!-- /BREADCRUMB -->
				...
				<div class="product product-details clearfix">
					<div class="col-md-6">
						<div id="product-main-view">
							...
							{{-- <div class="product-view">
								<img src="{{ URL::to('frontend/img/main-product02.jpg') }}" alt="">
							</div>
							<div class="product-view">
					...
					<div class="col-md-6">
						<div class="product-body">
							...
							<h3 class="product-price">$ {{$product_by_details->product_price}} <del class="product-old-price"> $ {{$product_by_details->product_price * 0.20}}</del></h3>
							<div>
							...
							<p><strong>Marca:</strong> {{$product_by_details->manufacture_name}}</p>
							<p><strong>Categoria:</strong> {{$product_by_details->category_name}}</p>
							...
							<div class="product-btns">
								<form action="{{url('add-to-cart')}}" method="POST">
									...
									<button type="submit" class="primary-btn add-to-cart"><i class="fa fa-shopping-cart"></i> AGREGAR</button>
								</form>
					...
					<div class="col-md-12">
						<div class="product-tab">
							<ul class="tab-nav">
								...
								{{-- <li><a data-toggle="tab" href="#tab3">Criticas (3)</a></li> --}}
							</ul>
